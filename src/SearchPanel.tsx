    ...
    <div className='search-panel'>
      ...
      <div className='search-bar search-advanced'>
        <div className='search-advanced-pane blue'>
          <div className='filter-group expanded'><CategoryFilter/></div>
          <div className='filter-group expanded'><WeaponsFilters/></div>
          <div className='filter-group expanded'><ArmourFilters/></div>
          <div className='filter-group expanded'><RequirementFilters/></div>
          <StatsFilter />
          </div>
